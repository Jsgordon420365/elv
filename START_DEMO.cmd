...
if errorlevel 1 (
  echo ERROR: Port 3000 is already in use. Stop the existing listener, then run START_DEMO.cmd again.
  exit /b 1
)
set NEXT_PUBLIC_DEMO_MODE=1
echo.
echo ELV LegalFlowNC demo URL: http://localhost:3000
